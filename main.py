...
from tkinter import Entry, Tk, Button, filedialog, Label, StringVar
...
class Watermarker(Tk):
    ...
    def open_image(self):
        ...
        self.photo = Photo(Image.open(filename))
    ...
    def make_watermark(self):
        ...
        d.text((img_width/2, img_height/2), watermark,
               font=wm_font, anchor='mm', fill=(0, 0, 0, 50))
    ...
    def save_image(self):
        ...
        d.text((img_width/2, img_height/2), self.watermark1,
               font=wm_font, anchor='mm', fill=(0, 0, 0, 50))
